package com.example.pda.ui.kiemke.nvl;
...
public class KiemKeNvlDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kiem_ke_nvl_detail);
    ...
    private void showFullInfoDialog() {
        ...
        setupRow(dialog.findViewById(R.id.rowShelf), "Mã Giá đỡ", "GD-NVL-X");
        setupRow(dialog.findViewById(R.id.rowNvl), "Mã NVL", "NVL-ABC-123");
        setupRow(dialog.findViewById(R.id.rowDescription), "Mô tả SP 1", "Nguyên liệu tấm nền mạch");
        setupRow(dialog.findViewById(R.id.rowUnit), "Đơn vị", "Tấm");
        setupRow(dialog.findViewById(R.id.rowAuditDate), "Ngày kiểm kê", "2024-05-23");
        setupRow(dialog.findViewById(R.id.rowLotNumber), "Số Lô", "SN-NVL-55");
        setupRow(dialog.findViewById(R.id.rowImportDate), "Ngày nhập", "2024-04-05");
        setupRow(dialog.findViewById(R.id.rowWarehouse), "Kho", "KHO-NGUYEN-LIEU");
        setupRow(dialog.findViewById(R.id.rowExpiry), "HSD", "2027-04-05");
        setupRow(dialog.findViewById(R.id.rowPoNo), "PoNo", "PO-NVL-SPEC-001");
        setupRow(dialog.findViewById(R.id.rowDept), "BP đặt", "BP-KHO-NVL");
